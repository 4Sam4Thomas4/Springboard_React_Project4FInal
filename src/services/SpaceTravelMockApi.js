  ...
  static MOCK_DB = {
    ...
    spacecrafts: [
      ...
      },
      {
        ...
        name: "Star Voyager",
        capacity: 50000,
        description: "Presenting the Rolls of the Sky 2000: a revolutionary spacecraft merging cutting-edge technology with lavish luxury, designed to usher an incredible 50,000 passengers into the solar system's embrace. A marvel of engineering, its sleek exterior is adorned with solar panels, fueling advanced propulsion while minimizing environmental impact." +
                     "Within, the vessel transforms into a haven of opulence. Lavish suites offer cosmic panoramas, celestial artwork bedecks lounges, and sprawling gardens thrive in zero-gravity. Culinary excellence reigns in gourmet restaurants, while immersive theaters and VR chambers offer stellar entertainment." +
                     "Safety remains paramount with cosmic radiation shielding and top-tier medical facilities. The Voyager not only advances space exploration but redefines elegance, uniting humanity's thirst for knowledge with a taste of the sublime.",
        pictureUrl: "https://media.gettyimages.com/id/501323914/photo/the-original-series.jpg?s=2048x2048&w=gi&k=20&c=95eP6_SBR199lES-rFfJr3Jp6nuPUXLjKlSOhCisYP8=",
        currentLocation: 6
      }
    ]
  };
